...
if("cuda" IN_LIST FEATURES)
  vcpkg_download_distfile(OCV_DOWNLOAD
    ...
    message(STATUS "FLINK_USE_CUDA = ${FLINK_USE_CUDA}")
    message(STATUS "CUDA_TOOLKIT_ROOT_DIR = ${CUDA_TOOLKIT_ROOT_DIR}")
    # check if env var CUDA_PATH is defined and check if folder exists, otherwise fail
    if (DEFINED ENV{CUDA_PATH})
      message(STATUS "CUDA_PATH = $ENV{CUDA_PATH}")
      if (NOT EXISTS "$ENV{CUDA_PATH}")
        message(FATAL_ERROR "CUDA_PATH: $ENV{CUDA_PATH} does not exist")
      endif()
    else ()
...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DX86=${TARGET_IS_X86}
        -DARM=${TARGET_IS_ARM}
        -DCUDA_PATH=${CUDA_TOOLKIT_ROOT_DIR}
        ###### ocv_options
